...
"""Curie Agent — Experimental validation (empty at the moment).
...
class CurieAgent(AbstractAgent):
    """Curie: Experimental validation (empty at the moment)."""
    ...
    def __init__(self, config: AgentConfig | None = None) -> None:
        ...
        self._log = logger.bind(agent="curie")
