...
"""Noether Agent — Symmetry and conservation (empty at the moment).
...
class NoetherAgent(AbstractAgent):
    """Noether: Symmetry and conservation (empty at the moment)."""
    ...
    def __init__(self, config: AgentConfig | None = None) -> None:
        ...
        self._log = logger.bind(agent="noether")
