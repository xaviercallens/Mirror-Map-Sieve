...
"""Ramanujan Agent — Intuitive number theory (empty at the moment).
...
class RamanujanAgent(AbstractAgent):
    """Ramanujan: Intuitive number theory (empty at the moment)."""
    ...
    def __init__(self, config: AgentConfig | None = None) -> None:
        ...
        self._log = logger.bind(agent="ramanujan")
