...
"""Heraclite Agent ADK Server.

Serves the Heraclite agent as a standalone Cloud Run
...
app = FastAPI(title="Heraclite Agent")

agent_card = AgentCard(
    name="Heraclite",
    description="Heraclite agent.",
