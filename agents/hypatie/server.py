...
"""Hypatie Agent ADK Server.

Serves the Hypatie agent as a standalone Cloud Run
...
app = FastAPI(title="Hypatie Agent")

agent_card = AgentCard(
    name="Hypatie",
    description="Hypatie agent.",
