...
# Replace CONJECTURES array using a lambda to avoid backslash parsing in replacement string
...
# Update the Real-World Impact block to Mistral Peer Review
old_impact_block = """                                            <div className="p-5 rounded-xl bg-gradient-to-br from-indigo-900/40 to-black border border-indigo-500/20 shadow-inner">
                                                <h4 className="text-sm font-semibold text-indigo-200 uppercase tracking-wider mb-2 flex items-center">
                                                    ...
                                                    Real-World Impact (Physics & Medicine)
                                                </h4>
...
new_impact_block = """                                            <div className="p-5 rounded-xl bg-gradient-to-br from-slate-900/40 to-black border border-slate-700/50 shadow-inner">
...
page = page.replace(old_impact_block, new_impact_block)
