...
\item \textbf{Fair long-range bake-off.} Learnable-ALiBi vs.\ NoPE vs.\ RoPE
  $+$ position-interpolation vs.\ fixed ALiBi, on a genuine long-range benchmark
  (e.g.\ PG-19, long-document QA), at $\ge$$10\times$ the parameter scale used
  here. Pre-commit the gate and the extrapolation protocol.
