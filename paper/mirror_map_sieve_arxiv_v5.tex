...
%%     CY 3-fold geometry, asymptotic prefactor, OEIS A397213.

\title{The Callens--Schmidt Sequence $S_{20}(n)$:\\
...
\]
a weight-$(4,1)$ Ap\'ery-like sequence (OEIS \href{https://oeis.org/A397213}{A397213}).  We prove that $S(n)$ admits a
...
sum $S(n)=\sum_{k=0}^n\binom{n}{k}^4\binom{n+k}{k}$ (OEIS \href{https://oeis.org/A397213}{A397213}).  The main results are:
\begin{itemize}
...
future work.  The sequence has been submitted to the OEIS as \href{https://oeis.org/A397213}{A397213}.
